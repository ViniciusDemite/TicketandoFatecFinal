...
{
    public class AuthFilerComissao : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (filterContext.HttpContext.Session["comissao"] == null)
            {
                filterContext.Result = new RedirectResult("/ComissaoLogin/ComissaoLogin");
            }
        }
